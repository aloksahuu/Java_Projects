...
public class calculatorTest {
	...
	@Test
	@Disabled // this will disable this method
//	@RepeatedTest(5)
	...
	public void testDivision() {
		// assertEquals(2, cal.division(10,0)); // this will not catch exception it will
		// give failure .
	...
	public void underDevelopment() {
		 System.out.println("Under progress... cannot be tested");
	}
