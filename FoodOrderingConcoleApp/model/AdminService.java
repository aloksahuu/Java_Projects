...
public class AdminService {
	...
	public static void viewMenu() {
		try (Connection conn = DBUtil.getConnection();
			...
			System.out.println("⚠️ Error fetching menu: " + e.getMessage());
		}
	}
	...
	public static void viewCustomers() {
		try (Connection conn = DBUtil.getConnection();
			...
			System.out.println("⚠️ Error fetching customers: " + e.getMessage());
		}
	}
	...
	public static void viewDeliveryPartners() {
		try (Connection conn = DBUtil.getConnection();
			...
			System.out.println("⚠️ Error fetching delivery partners: " + e.getMessage());
		}
	}
}
